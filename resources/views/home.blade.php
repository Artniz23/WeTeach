...
@section('content')
    ...
    <section class="font-sans container m-auto flex px-5">
        ...
        <div class="flex-1 flex items-start flex-col justify-center">
            ...
            <form class="block sm:flex w-full px-0 sm:px-16 xl:pr-32 lg:pr-16 md:px-32 lg:px-0" action="https://gmail.us4.list-manage.com/subscribe/post?u=5e42c16aa51bfc30ebc9e1d41&amp;id=360510f12c" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" target="_blank" novalidate>
                ...
                <input type="hidden" name="b_5e42c16aa51bfc30ebc9e1d41_360510f12c" tabindex="-1" value="">
    ...
    <section class="text-center pt-32 pb-40 bg-pink-500 relative">
        ...
        <div class="container mx-auto text-center px-5">
            ...
            <form class="block sm:flex w-full px-0 sm:px-16 xl:pr-6 lg:pr-16 md:px-32 lg:px-0 lg:w-1/2 lg:m-auto lg:mt-8" action="https://gmail.us4.list-manage.com/subscribe/post?u=5e42c16aa51bfc30ebc9e1d41&amp;id=360510f12c" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" target="_blank" novalidate>
